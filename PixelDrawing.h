...
public:
	...
	int goUp(long, long*, std::vector<long>*, HDC*, long*);
	int goDown(long, long*, std::vector<long>*, HDC*, long*);
	int goRight(long, long*, std::vector<long>*, HDC*, long*);
	int goLeft(long, long*, std::vector<long>*, HDC*, long*);

public:
	void setPixelPosition(long, long);
	void setPixelValue(long);
	void drawPixel(std::vector<long>*, HDC*, long*);
