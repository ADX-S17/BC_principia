...
int PixelDrawing::goUp(long lMoveNumber, long *lValue, std::vector<long> *vPrimeNumbers, HDC* deviceContent, long* maxValue)
{
	...
	for (long l = 1; l <= lMoveNumber; l++)
	{
		...
		this->drawPixel(vPrimeNumbers, deviceContent, maxValue);
		lVal++;
	}
...
int PixelDrawing::goDown(long lMoveNumber, long *lValue, std::vector<long> *vPrimeNumbers, HDC* deviceContent, long* maxValue)
{
...
int PixelDrawing::goRight(long lMoveNumber, long *lValue, std::vector<long> *vPrimeNumbers, HDC* deviceContent, long* maxValue)
{
...
int PixelDrawing::goLeft(long lMoveNumber, long *lValue, std::vector<long> *vPrimeNumbers, HDC* deviceContent, long* maxValue)
{
...
void PixelDrawing::drawPixel(std::vector<long>* vPrimeNumbers, HDC* deviceContent, long* maxValue)
{
